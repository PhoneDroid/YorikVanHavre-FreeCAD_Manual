...
![creating a custom tool](https://wiki.freecad.org/images/5/57/Exercise_python_04.jpg)
...
![adding a toolbar](https://wiki.freecad.org/images/6/66/Exercise_python_05.jpg)
...
* The FreeCAD macros repository: https://wiki.freecad.org/index.php?title=Macros_recipes
* Parametric object example: https://wiki.freecad.org/index.php?title=Scripted_objects
